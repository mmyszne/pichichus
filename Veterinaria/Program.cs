...
namespace VeterinariaPichichus
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<DuenioContext>(options =>
            options.UseSqlServer(builder.Configuration["ConnectionString:DuenioDBConnection"]));
